--------------------------------------------------------
--  DDL for Procedure F14_3_QUARTER_MISSED_SHOTS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "IS620PMACMIL1"."F14_3_QUARTER_MISSED_SHOTS" 
(
p_quarter_id INT
)
...
create_shot_missed_table := 
   ...
   AND PLAY_EVENT.event_type != ''free_throw_missed''
